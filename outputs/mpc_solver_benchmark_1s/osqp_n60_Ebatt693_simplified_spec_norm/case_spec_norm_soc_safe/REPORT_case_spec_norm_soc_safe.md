...
- Output directory: `outputs\mpc_solver_benchmark_1s\osqp_n60_Ebatt693_simplified_spec_norm\case_spec_norm_soc_safe`
...
- infeasible_count: `0`
- fallback_count: `0`
- mean / median / p90 / p95 / p99 / max solve time: `2.240` / `0.901` / `2.350` / `6.810` / `42.477` / `107.895` ms
- real_time_factor_mean: `0.002240`
- real_time_factor_p99: `0.042477`
- 1 s real-time gate passed: `True`

## Control Metrics

- total_h2_cost / H2_total_kg: `284.362628`
- SOC min/max/initial/final/final_minus_initial_mean: `0.430088` / `0.550000` / `0.550000` / `0.520461` / `-0.029539`
- SOC final_minus_initial_min by voyage: `-0.089677`
- SOC mean_abs_deviation: `0.050321`
- battery throughput/discharge/charge: `1803.636475` / `973.464064` / `830.172411` kWh
- P_batt mean_abs/max/min: `69.794921` / `317.203090` / `-346.546922` kW
- P_batt abs<=1 kW fraction: `0.153239`
- P_fc mean/max/min: `202.741204` / `560.055844` / `-0.000084` kW
- fc_ramp_max / ramp_violation_count: `48.031562` kW/step / `2`
- power_balance_violation_max: `0.003483` kW
- SOC/battery/FC power violation counts: `0` / `0` / `0`
- battery/FC power violation max residuals: `0.046922` / `0.055844` kW; count tolerance `0.1 kW`
...
- SOC_final_minus_initial_min=-0.089677 < -0.02

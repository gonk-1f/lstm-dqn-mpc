...
- Output directory: `outputs\mpc_solver_benchmark_1s\osqp_n60_Ebatt693_simplified_spec_norm\case_spec_norm_h2_high_economy`
...
- infeasible_count: `0`
- fallback_count: `0`
- mean / median / p90 / p95 / p99 / max solve time: `2.946` / `1.067` / `4.594` / `11.479` / `45.942` / `111.733` ms
- real_time_factor_mean: `0.002946`
- real_time_factor_p99: `0.045942`
- 1 s real-time gate passed: `True`

## Control Metrics

- total_h2_cost / H2_total_kg: `274.770115`
- SOC min/max/initial/final/final_minus_initial_mean: `0.390894` / `0.550000` / `0.550000` / `0.491760` / `-0.058240`
- SOC final_minus_initial_min by voyage: `-0.081720`
- SOC mean_abs_deviation: `0.075407`
- battery throughput/discharge/charge: `1290.672854` / `786.597873` / `504.074982` kWh
- P_batt mean_abs/max/min: `49.941661` / `346.523414` / `-346.500000` kW
- P_batt abs<=1 kW fraction: `0.140654`
- P_fc mean/max/min: `197.359092` / `560.043898` / `-0.029291` kW
- fc_ramp_max / ramp_violation_count: `48.000000` kW/step / `0`
- power_balance_violation_max: `0.003735` kW
- SOC/battery/FC power violation counts: `0` / `0` / `0`
- battery/FC power violation max residuals: `0.023414` / `0.043898` kW; count tolerance `0.1 kW`
...
Invalid reasons:
- SOC_final_minus_initial_min=-0.081720 < -0.02

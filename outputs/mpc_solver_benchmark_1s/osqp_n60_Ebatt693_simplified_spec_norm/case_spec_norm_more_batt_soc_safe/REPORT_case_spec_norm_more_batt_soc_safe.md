...
- Output directory: `outputs\mpc_solver_benchmark_1s\osqp_n60_Ebatt693_simplified_spec_norm\case_spec_norm_more_batt_soc_safe`
...
- success_rate: `0.999936`
- infeasible_count: `0`
- fallback_count: `0`
- mean / median / p90 / p95 / p99 / max solve time: `2.910` / `1.144` / `4.162` / `12.227` / `39.928` / `1117.804` ms
- real_time_factor_mean: `0.002910`
- real_time_factor_p99: `0.039928`
- 1 s real-time gate passed: `False`

## Control Metrics

- total_h2_cost / H2_total_kg: `283.509960`
- SOC min/max/initial/final/final_minus_initial_mean: `0.421948` / `0.550000` / `0.550000` / `0.516598` / `-0.033402`
- SOC final_minus_initial_min by voyage: `-0.090767`
- SOC mean_abs_deviation: `0.049177`
- battery throughput/discharge/charge: `1885.219214` / `1023.625652` / `861.593561` kWh
- P_batt mean_abs/max/min: `72.951910` / `321.416555` / `-346.503248` kW
- P_batt abs<=1 kW fraction: `0.175468`
- P_fc mean/max/min: `202.015143` / `560.057633` / `-0.000084` kW
- fc_ramp_max / ramp_violation_count: `48.005837` kW/step / `1`
- power_balance_violation_max: `0.003474` kW
- SOC/battery/FC power violation counts: `0` / `0` / `0`
- battery/FC power violation max residuals: `0.003248` / `0.057633` kW; count tolerance `0.1 kW`

## Validity Decision

- Current weights are `invalid`.
- Failure categories: `solver_too_slow;constraint_violation_failed;SOC_sustain_failed`
...
Invalid reasons:
- timing gate failed: mean=2.910 ms, p95=12.227 ms, p99=39.928 ms, max=1117.804 ms
- constraint check failed: balance_max=0.003474 kW, SOC_count=0, battery_count=0, FC_count=0, ramp_count=1
- SOC_final_minus_initial_min=-0.090767 < -0.02

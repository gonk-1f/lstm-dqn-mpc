...
- Output directory: `outputs\mpc_solver_benchmark_1s\osqp_n60_Ebatt693_simplified_spec_norm\case_spec_norm_h2_low_fc_main`
...
- success_rate: `0.999968`
- infeasible_count: `0`
- fallback_count: `0`
- mean / median / p90 / p95 / p99 / max solve time: `0.767` / `0.258` / `1.112` / `2.614` / `10.259` / `89.064` ms
- real_time_factor_mean: `0.000767`
- real_time_factor_p99: `0.010259`
- 1 s real-time gate passed: `True`

## Control Metrics

- total_h2_cost / H2_total_kg: `293.873401`
- SOC min/max/initial/final/final_minus_initial_mean: `0.445939` / `0.580935` / `0.550000` / `0.554336` / `0.004336`
- SOC final_minus_initial_min by voyage: `-0.016661`
- SOC mean_abs_deviation: `0.033950`
- battery throughput/discharge/charge: `1817.623008` / `898.295691` / `919.327318` kWh
- P_batt mean_abs/max/min: `70.333887` / `267.123508` / `-346.517790` kW
- P_batt abs<=1 kW fraction: `0.146430`
- P_fc mean/max/min: `209.102359` / `560.055730` / `-0.000039` kW
- fc_ramp_max / ramp_violation_count: `48.015419` kW/step / `1`
- power_balance_violation_max: `0.003319` kW
- SOC/battery/FC power violation counts: `0` / `0` / `0`
- battery/FC power violation max residuals: `0.017790` / `0.055730` kW; count tolerance `0.1 kW`

## Validity Decision

- Current weights are `invalid`.
- Failure categories: `constraint_violation_failed`
...
Invalid reasons:
- constraint check failed: balance_max=0.003319 kW, SOC_count=0, battery_count=0, FC_count=0, ramp_count=1

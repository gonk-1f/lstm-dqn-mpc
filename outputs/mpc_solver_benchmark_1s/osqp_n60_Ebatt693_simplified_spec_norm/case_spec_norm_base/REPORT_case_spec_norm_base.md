...
- Output directory: `outputs\mpc_solver_benchmark_1s\osqp_n60_Ebatt693_simplified_spec_norm\case_spec_norm_base`
...
- infeasible_count: `0`
- fallback_count: `0`
- mean / median / p90 / p95 / p99 / max solve time: `3.434` / `1.166` / `5.157` / `12.383` / `56.413` / `173.519` ms
- real_time_factor_mean: `0.003434`
- real_time_factor_p99: `0.056413`
- 1 s real-time gate passed: `True`

## Control Metrics

- total_h2_cost / H2_total_kg: `272.900170`
- SOC min/max/initial/final/final_minus_initial_mean: `0.388617` / `0.550000` / `0.550000` / `0.484372` / `-0.065628`
- SOC final_minus_initial_min by voyage: `-0.084364`
- SOC mean_abs_deviation: `0.075847`
- battery throughput/discharge/charge: `1254.324621` / `786.341931` / `467.982689` kWh
- P_batt mean_abs/max/min: `48.535192` / `346.521324` / `-346.500607` kW
- P_batt abs<=1 kW fraction: `0.150198`
- P_fc mean/max/min: `195.972432` / `560.054679` / `-0.039783` kW
- fc_ramp_max / ramp_violation_count: `48.000000` kW/step / `0`
- power_balance_violation_max: `0.003953` kW
- SOC/battery/FC power violation counts: `0` / `0` / `0`
- battery/FC power violation max residuals: `0.021324` / `0.054679` kW; count tolerance `0.1 kW`
...
Invalid reasons:
- SOC_final_minus_initial_min=-0.084364 < -0.02

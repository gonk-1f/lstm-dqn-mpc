...
- Output directory: `outputs\mpc_solver_benchmark_1s\osqp_n60_Ebatt277p2_simplified_spec_norm\case_spec_norm_soc_strong`
...
- success_rate: `0.983845`
- infeasible_count: `1330`
- fallback_count: `0`
- mean / median / p90 / p95 / p99 / max solve time: `0.434` / `0.191` / `0.860` / `1.021` / `2.179` / `79.265` ms
- real_time_factor_mean: `0.000434`
- real_time_factor_p99: `0.002179`
- 1 s real-time gate passed: `False`

## Control Metrics

- total_h2_cost / H2_total_kg: `421.850820`
- SOC min/max/initial/final/final_minus_initial_mean: `0.469695` / `0.549979` / `0.550000` / `0.505720` / `-0.044280`
- SOC final_minus_initial_min by voyage: `-0.071350`
- SOC mean_abs_deviation: `0.041194`
- battery throughput/discharge/charge: `2836.694517` / `121.200747` / `2715.493770` kWh
- P_batt mean_abs/max/min: `111.566197` / `138.526154` / `-138.654651` kW
- P_batt abs<=1 kW fraction: `0.093473`
- P_fc mean/max/min: `302.982584` / `560.063803` / `-0.000039` kW
- fc_ramp_max / ramp_violation_count: `48.026834` kW/step / `5`
- power_balance_violation_max: `0.002066` kW
- SOC/battery/FC power violation counts: `0` / `0` / `0`
- battery/FC power violation max residuals: `0.054651` / `0.063803` kW; count tolerance `0.1 kW`
...
- solver_success_rate=0.983845, infeasible_count=1330
- timing gate failed: mean=0.434 ms, p95=1.021 ms, p99=2.179 ms, max=79.265 ms
- constraint check failed: balance_max=0.002066 kW, SOC_count=0, battery_count=0, FC_count=0, ramp_count=5
- SOC_final_minus_initial_min=-0.071350 < -0.02
- fraction(abs(P_batt)>=95% limit)=0.709703 > 0.05
